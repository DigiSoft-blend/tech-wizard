        ...
        <div class="col-md-12">
           <comp1></comp1>
              ...
              <!-- <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Users Credentials</h4> -->
                    <div class="table-responsive">
                       
                      <table class="table" style="color:#259f">
                        <thead>
                          <tr>
                            <th>
                        ...
                        <tbody>
                          <tr  v-for="user in getUsers" :key="user.id">
                           ...
                           <span>
                               <a @click="removeUser(user.id)" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Delete</a>
                           </span>
                            </td>
                          </tr>
