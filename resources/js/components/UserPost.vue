<template>
    <div class="row myfont">
           ...
           <div class="col-md-12 p-0 m-0">
            ...
            <h5  v-if="getUserPost != ''" class="text-dark">your post</h5>
             <h5 v-if="getUserPost == ''" class="text-dark">No post added</h5>  

            <div v-for="user_post in getUserPost" :key="user_post.id" class="col-md-12 col-xl-12 border-secondary border-bottom curv mt-4">

                <h5 v-if=" getUserPost == ''" class="text-dark">No post added</h5>    
                 <div class="d-flex flex-row justify-content-between">
                  <p class="card-title text-primary">{{ user_post.title }}</p>
               ...
               <div v-if="loggedIn" class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <router-link :to="'/edit-post/'+ user_post.id">
                  ...
                  <a @click="removePost(user_post.id)" class="dropdown-item preview-item text-light">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                    ...
                    <div class="preview-item-content">
                     ...
                     <p class="text-gray">{{ user_post.created_at }}</p>
                    </div>
            </div>
</template>
